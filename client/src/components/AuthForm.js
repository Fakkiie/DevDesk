...
const AuthForm = () => {
  ...
  return (
      <div className="flex justify-center items-center w-full h-full bg-gray-100">
        <div className = "flex w-full max-w-xl h-full max-h-min bg-white border-2 border-gray-200 rounded-xl shadow-lg hover:shadow-xl p-20 justify-center items-center">
